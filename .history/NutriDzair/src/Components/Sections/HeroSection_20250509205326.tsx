...
const HeroSection = () => {
    return (url('..
        <section className="h-screen min-w-full flex items-center justify-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `/../assets/Images/Background_image.jpg')` }}>
