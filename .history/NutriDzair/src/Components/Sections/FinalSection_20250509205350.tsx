...
const FinalSection = () => {
    return (
        <section className='h-screen min-w-full flex flex-col bg-[rgba(221,221,221,1)] items-center justify-center ' style={{ background:`url('../../assets/Images/footer_bg.jpg')` }}>
